...
program DrawReadKeyboard;
 ...
 // ѕолучить символ нажатой клавиши. ≈сли ничего не нажато, то возвращаетс€ #0.
 // »спользуетс€ дл€ добавлени€ интерактивности в консольное приложение,
 // например дл€ получени€ информации о текущем состо€нии работающей программы.
